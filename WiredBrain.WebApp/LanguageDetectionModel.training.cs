...
namespace WiredBrain_WebApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Josvany_G\Documents\PluralSight\Descargas\dot-net-building-apps-machine-learning\03\demos\after\TrainingData\languageDetection_vNext.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Message",outputColumnName:@"Message")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(new SdcaMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.18452188F,L2Regularization=0.03125F,LabelColumnName=@"Language",FeatureColumnName=@"Features"}))      
